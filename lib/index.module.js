...
function ES256HSMSigner(pufHsmRemoteUrl) {
  return function (data) {
    try {
      return Promise.resolve(_catch$2(function () {
        const hashArray = sha256(data);
        const hashHex = uint8ArrayToHex(hashArray);
        return Promise.resolve(fetch(`${pufHsmRemoteUrl}pufs_p256_sign_js`, {
          method: 'POST',
          headers: {
          ...
          function _temp2(_result) {
            return _exit ? _result : Promise.resolve(response.json()).then(function (signature) {
              return toJose({
          ...
          const _temp = function () {
            if (!response.ok) {
              return Promise.resolve(response.text()).then(function (errorText) {
